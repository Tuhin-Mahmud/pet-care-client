    ...
    return (
        <div>
            ...
            <div className='w-3/4 mx-auto mb-10'>
                ...
                <div className='flex  md:space-x-5 text-sm  md:text-lg mt-4 mb-5'>
                    <p className='text-sky-400 border-s-2 ps-1 md:ps-2'>March 18 2024</p>
                    <p className='border-s-2 ps-1 md:ps-2'>Pet care</p>
                    <p className='border-s-2 ps-1 md:ps-2'>Pet Grooming</p>
                </div>
                <div className='space-y-2 md:space-y-3'>
                    <h2 className=' md:text-4xl font-serif hover:text-sky-400 '>Online Pet Everything Your Pet Needs</h2>
            ...
            <div className='w-3/4 mx-auto mb-10'>
                ...
                <div className='flex md:space-x-5 text-sm md:text-lg mt-4 mb-5'>
                    <p className='text-sky-400 border-s-2 ps-1 md:ps-2'>January 10 2024</p>
                    <p className='border-s-2 ps-1 md:ps-2'>Pet care</p>
                    <p className='border-s-2 ps-1 md:ps-2'>Pet Grooming</p>
                    <p className='border-s-2 ps-1 md:ps-2'>4 comments</p>
                </div>
                <div className='space-y-3'>
                    <h2 className='md:text-4xl  font-serif hover:text-sky-400 '> Some toughly useful much walking before</h2>
                ...
                <div className='border my-3 border-sky-200 bg-slate-300 md:h-[150px] px-5 py-2 rounded hover:bg-slate-700 hover:text-white duration-700'>
            ...
            <div className='w-3/4 mx-auto mb-10'>
                ...
                <div className='flex md:space-x-5 text-sm  md:text-lg mt-4 mb-5'>
                    <p className='text-sky-400 border-s-2 ps-1 md:ps-2'>february 08 2024</p>
                    <p className='border-s-2 ps-1 md:ps-2'>Pet care</p>
                    <p className='border-s-2 ps-1 md:ps-2'>Pet Grooming</p>
                    <p className='border-s-2 ps-1 md:ps-2'>1 comment</p>
                </div>
                <div className='space-y-3'>
                    <h2 className='md:text-4xl font-serif hover:text-sky-400 '>We want to ensure the happiness for the pets.</h2>
            ...
            <div className='w-3/4 mx-auto mb-10'>
                ...
                <div className='flex md:space-x-5 text-sm  md:text-lg mt-4 mb-5'>
                    <p className='text-sky-400 border-s-2 ps-1 md:ps-2'>april 05 2024</p>
                    <p className='border-s-2 ps-1 md:ps-2'>Pet care</p>
                    <p className='border-s-2 ps-1 md:ps-2'>Pet Grooming</p>
                    <p className='border-s-2 ps-1 md:ps-2'>4 comment</p>
                </div>
                <div className='space-y-3'>
                    <h2 className='md:text-4xl font-serif hover:text-sky-400 '>Acute yellow re-laid less or affirmatively cats</h2>
