        ...
        <div className=''>
            <div className="carousel w-full">
                <div id="slide1" className="carousel-item relative w-full h-[600px]">
                    <img src={banner1} className=" md:w-full object-cover h-[600px] rounded-xl" />
                    {/* content */}
                    <div className="absolute flex items-center transform -translate-y-1/2 left-5 right-5   bottom-0 ">
                ...
                <div id="slide2" className="carousel-item relative w-full h-[600px]">
                    <img src={banner2} className="w-full object-cover h-[600px] rounded-xl" />
                    {/* content */}
                    <div className="absolute flex items-center  left-0 right-5 top-0  bottom-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)] h-full w-full">
                        <div className=' ml-5 text-white md:w-1/2'>
                            <h2 className='text-5xl font-serif capitalize font-medium  '>Urban Companions<span className='text-sky-600'> The Resilient Beauty </span> <br />  of Pigeons</h2>
                ...
                <div id="slide3" className="carousel-item relative w-full h-[600px]">
                    <img src={banner3} className="w-full object-cover h-[600px] rounded-xl" />
                    {/* content */}
                    <div className="absolute flex  transform -translate-y-1/2 left-5 right-5   bottom-0 ">
                        <div className='  text-stone-800 md:w-1/2'>
                            <h2 className='text-6xl font-serif capitalize font-medium  '>Loyal Companions  of <span className='text-sky-600'>The Heart and Soul</span> <br /> Canine Friendship</h2>
                            <p className='mb-3'>
                                Cats are small, carnivorous mammals known for their agility, grace, and independent nature. They make delightful companions, offering affection and companionship. With their unique personalities, cats thrive in a variety .</p>
                            <div className=''>
                                <button className="btn btn-active btn-secondary ">book appointment</button>
                ...
                <div id="slide4" className="carousel-item relative w-full h-[600px]">
                    <img src={banner4} className="w-full object-cover h-[600px] rounded-xl" />
                    {/* content */}
                    <div className="absolute flex items-center  left-0 right-5 top-0  bottom-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)] h-full w-full">
                        <div className=' ml-5 md:w-1/2 text-gray-300'>
                            <h2 className='text-6xl font-serif capitalize font-medium'>The Charm and<br />
                                <span className='text-sky-600'>Grace of</span> <br />   Rabbits</h2>
                            <p className='mb-3'>
