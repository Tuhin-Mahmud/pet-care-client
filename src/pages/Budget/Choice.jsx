    ...
    return (
        <div className="my-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 ">
                {/* 1 */}
                <div className="group relative max-w-[350px] h-[180px] overflow-hidden bg-gradient-to-r from-[#96C9F4] via-[#48CFCB] to-[#4FB5FF] px-6 py-6 text-white shadow rounded-tr-2xl items-center flex justify-center ml-16 md:ml-0">
                ...
                {/* 2 */}
                <div className="group relative max-w-[350px] h-[180px] overflow-hidden bg-gradient-to-r from-[#96C9F4] via-[#4FB5FF] to-[#4FB5FF] px-6 py-6 text-white shadow rounded-tr-2xl items-center flex justify-center ml-16 md:ml-0">
